...
class TestProfile:
    ...
    def test_DashBoard(self,logged_in_browser):
        ...
        dashboard.book_a_trip(point_a="2700 16th Avenue, Edgewood, Washington 98354, United States ",
            point_b="9237 College Way North, Seattle, Washington 98103, United States ",
