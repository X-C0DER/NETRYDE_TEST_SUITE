...
class TestTCE2E002LOGIN2():
    # Setup method to initialize the WebDriver and variables
    ...
    # Test method to perform the login and booking trip functionality
    def test_tCE2E002LOGIN2(self):
        # Navigate to the website
        self.driver.get("https://dev-np.netryde.com/")
        self.driver.set_window_size(1366, 728)
        
        # Click on the login area and then select "Login as a Customer"
        ...
        # Click on "Book another trip" and scroll to the top of the page
